...
persistenceCore tx --chain-id "test-core-2" gov submit-legacy-proposal software-upgrade "v11.1.0" \
    ...
    --upgrade-info "https://raw.githubusercontent.com/persistenceOne/networks/upgrade-v11.1.0/test-core-2/upgrades/v11.1.0/binaries.json?checksum=sha256:40eb91525b82935d81f707583e0e581a6845ffcde8df6aeb9aa63cf25480845d" \
