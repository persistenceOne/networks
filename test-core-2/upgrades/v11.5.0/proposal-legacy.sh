...
persistenceCore tx --chain-id "test-core-2" gov submit-legacy-proposal software-upgrade "v11.5.0" \
    ...
    --upgrade-info "https://raw.githubusercontent.com/persistenceOne/networks/test-core-2/upgrades/v11.5.0/test-core-2/upgrades/v11.5.0/binaries.json?checksum=sha256:xxx" \
