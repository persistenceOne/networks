...
persistenceCore tx gov submit-legacy-proposal software-upgrade "Upgrade v9.2.0 PersistenceCore" \
    ...
    --upgrade-info "https://raw.githubusercontent.com/persistenceOne/networks/f/test-core-2/upgrades/v9.2.0/test-core-2/upgrades/v9.2.0/binaries.json?checksum=sha256:d2c50e9bea0aab82ca8bd4d97a7b654a46fad061978def4c20df31624cb6352b" \
