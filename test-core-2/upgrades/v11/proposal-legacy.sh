...
persistenceCore tx --chain-id "test-core-2" gov submit-legacy-proposal software-upgrade "v11" \
    ...
    --upgrade-info "https://raw.githubusercontent.com/persistenceOne/networks/test-core-2/upgrades/v11/test-core-2/upgrades/v11/binaries.json?checksum=sha256:XXX" \
